...
import { Search, Zap, ChevronRight, Lock, CheckCircle, Shield, Award, BarChart3, Mail } from 'lucide-react';
            ...
            >
                    ...
                    <div className="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-12 items-center z-10">
                        ...
                        <div className="space-y-8 text-center lg:text-left animate-fade-in-up">
                            ...
                            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-indigo-50 border border-indigo-100 mb-2">
                                ...
                                <span className="text-[10px] uppercase font-bold text-indigo-600 tracking-widest">Plataforma Docente Segura</span>
                            </div>
                        ...
                        <div className="flex justify-center lg:justify-end animate-in fade-in slide-in-from-bottom-8 duration-700 delay-100">
                            <div className="bg-white p-8 md:p-10 rounded-[32px] shadow-2xl shadow-indigo-900/10 border border-slate-100 w-full max-w-md relative overflow-hidden">
                                ...
                                <div className="mb-8 text-center">
                                    ...
                                    <h2 className="text-2xl font-black text-slate-900 mb-2">Acceso Docente</h2>
                                    <p className="text-slate-400 text-sm font-medium">Introduce tu token corporativo</p>
                                </div>
                                ...
                                <form onSubmit={handleFormSubmit} className="space-y-4">
                                    <div>
                                        <input
                                            type="text"
                                            autoFocus
                                            className={`w-full h-14 px-4 bg-slate-50 border-2 rounded-xl focus:bg-white outline-none transition-all text-center text-lg font-bold text-slate-800 tracking-widest placeholder:text-slate-300 placeholder:font-normal placeholder:tracking-normal
                                                ${errorMessage ? 'border-rose-300 focus:border-rose-500' : 'border-slate-100 focus:border-indigo-500'}`}
                                    ...
                                    <button
                                        ...
                                        className={`w-full h-14 font-bold rounded-xl shadow-lg transition-all flex items-center justify-center gap-2 group
                                            ${isLoading ? 'bg-slate-200 text-slate-400 cursor-not-allowed' : 'bg-slate-900 text-white hover:bg-slate-800 hover:scale-[1.02]'}`}
                                    >
                                        {isLoading ? (
                                ...
                                <div className="mt-8 text-center flex flex-col gap-2">
                                    <a href="/exam-correction/blog" className="text-xs font-bold text-slate-400 hover:text-violet-600 transition-colors">
                                        Explora el Blog de Hipatia
                                    </a>
                                    <a href="/exam-correction/contacto" className="text-xs font-bold text-slate-400 hover:text-indigo-600 transition-colors">
                                        ¿Necesitas ayuda? Contactar soporte
                                    </a>
                                    <p className="text-[10px] text-slate-300 font-bold uppercase tracking-widest mt-2">
                                        HIPAT<span className="text-indigo-400">IA</span> Ecosistema v4.0
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="space-y-8">
                            ...
                            <ul className="space-y-6">
                                <li className="flex gap-4">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-slate-900 text-lg">1. El Juez (Análisis)</h4>
                                        <p className="text-slate-500">Lectura OCR y extracción de evidencias crudas.</p>
                                    </div>
                                </li>
                                <li className="flex gap-4">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-slate-900 text-lg">2. El Auditor (Rúbrica)</h4>
                                        <p className="text-slate-500">Contraste estricto con los criterios de evaluación.</p>
                                    </div>
                                </li>
                                <li className="flex gap-4">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-slate-900 text-lg">3. Tribunal Supremo (Informe)</h4>
                                        <p className="text-slate-500">Redacción pedagógica de la justificación final.</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
                        <div className="relative group w-full max-w-[300px] mx-auto">
                            <div className="absolute -inset-4 bg-gradient-to-r from-indigo-500 to-violet-500 rounded-2xl opacity-20 group-hover:opacity-30 blur-xl transition-all"></div>
                            <img
                                src="/blog-triple-consenso.jpg.png"
                                alt="Triple Consenso Workflow"
                                className="relative rounded-2xl shadow-2xl border-4 border-white transform group-hover:scale-[1.01] transition-transform duration-500 w-full"
                            />
                        </div>
                    </RevealSection>
                </section>
                ...
                <section className="py-16 px-6 bg-slate-50/50">
                    <RevealSection className="w-full max-w-4xl mx-auto text-center space-y-12">
                        ...
                        <div className="relative inline-block w-full max-w-[300px] mx-auto">
                            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full bg-indigo-500/20 rounded-full blur-[120px]"></div>
                            <img
                                src="/imagen articulo 5.png"
                                alt="Hipatia Informes"
                                className="relative rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.1)] border border-slate-200 w-full"
                            />
                        </div>
                    </RevealSection>
                </section>
                ...
                <section className="py-16 px-6 bg-white">
                    <RevealSection className="w-full max-w-6xl mx-auto">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                            {/* Feature 1 */}
                            <div className="text-center space-y-6 group p-6 rounded-3xl hover:bg-slate-50 transition-colors">
                                <div className="w-24 h-24 mx-auto mb-6 relative">
                                    <div className="absolute inset-0 bg-indigo-100/50 rounded-full blur-xl group-hover:bg-indigo-200/50 transition-all"></div>
                                    <img src="/icon-ocr.png" alt="OCR" className="relative w-full h-full object-contain p-2" />
                                </div>
                                <h3 className="text-2xl font-black text-slate-900">OCR de Precisión</h3>
                            ...
                            <div className="text-center space-y-6 group p-6 rounded-3xl hover:bg-slate-50 transition-colors">
                                <div className="w-24 h-24 mx-auto mb-6 relative">
                                    <div className="absolute inset-0 bg-violet-100/50 rounded-full blur-xl group-hover:bg-violet-200/50 transition-all"></div>
                                    <img src="/icon-privacy.png" alt="Privacy" className="relative w-full h-full object-contain p-2" />
                                </div>
                                <h3 className="text-2xl font-black text-slate-900">Privacidad Blindada</h3>
                                <p className="text-slate-500 font-medium leading-relaxed">
                            ...
                            <div className="text-center space-y-6 group p-6 rounded-3xl hover:bg-slate-50 transition-colors">
                                ...
                                <h3 className="text-2xl font-black text-slate-900">Sincronización Cloud</h3>
                                <p className="text-slate-500 font-medium leading-relaxed">
                ...
                {showChat && (
                    <div className="fixed bottom-8 right-8 z-50 animate-in fade-in slide-in-from-bottom-10 flex flex-col items-end gap-4">
                        ...
                        {isChatOpen && (
                            <div className="bg-white w-[350px] md:w-[400px] h-[500px] rounded-2xl shadow-2xl border border-slate-200 flex flex-col overflow-hidden animate-in zoom-in-95 origin-bottom-right mb-2">
                                {/* Chat Header */}
                                <div className="p-4 bg-slate-900 flex items-center justify-between shrink-0">
                                    <div className="flex items-center gap-3">
                                        <div className="w-8 h-8 rounded-full bg-gradient-to-r from-indigo-500 to-violet-500 flex items-center justify-center text-white font-black text-xs">
                                            H
                                        </div>
                                        <div>
                                            <h4 className="font-bold text-white text-sm">Asistente Hipatia</h4>
                                            <p className="text-[10px] text-slate-300 font-medium">En línea • IA Educativa</p>
                                        </div>
                                    </div>
                                    <button
                                        ...
                                        <div key={idx} className={`flex ${msg.role === 'user' ? 'justify-end' : 'justify-start'}`}>
                                            <div
                                                ...
                                                ${msg.role === 'user'
                                                        ...
                                                        : 'bg-white border border-slate-200 text-slate-700 rounded-tl-sm prose prose-sm prose-p:my-1 prose-headings:my-2 prose-ul:my-1 prose-li:my-0'}`}
                                            >
                                                {msg.text === '...' ? (
                                                    ...
                                                    <ReactMarkdown
                                                        components={{
                                                            a: ({ node, ...props }) => <a {...props} className="text-indigo-600 underline font-bold hover:text-indigo-700" target="_blank" rel="noopener noreferrer" />,
                                ...
                                <form onSubmit={handleSendMessage} className="p-3 bg-white border-t border-slate-100 flex gap-2">
                                    <input
                                        ...
                                        className="flex-1 bg-slate-50 border border-slate-200 rounded-xl px-4 py-2 text-sm focus:bg-white focus:border-indigo-500 outline-none text-slate-700 placeholder:text-slate-400 transition-all font-medium"
                                        disabled={isTyping}
                                    />
                                    <button
                                        type="submit"
                                        disabled={!inputMessage.trim() || isTyping}
                                        className="w-10 h-10 bg-slate-900 text-white rounded-xl flex items-center justify-center hover:bg-indigo-600 active:scale-95 transition-all disabled:opacity-50 disabled:active:scale-100 shadow-md"
                                    >
                        ...
                        <div
                            ...
                            className={`bg-white rounded-full shadow-2xl p-4 border border-indigo-100 cursor-pointer hover:scale-110 transition-transform relative group
                            ${isChatOpen ? 'bg-slate-900 border-slate-800 text-white rotate-90' : 'text-indigo-600'}`}
                        >
                            {!isChatOpen && (
