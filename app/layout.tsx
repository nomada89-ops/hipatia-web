...
export default function RootLayout({
    ...
    return (
        <html lang='es'>
            <body
                className={`${inter.variable} ${merriweather.variable} ${jetbrainsMono.variable} antialiased selection:bg-emerald-100 selection:text-emerald-900 bg-stone-50 text-stone-800`}
            >
                {children}
            </body>
        </html>
